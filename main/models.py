...
class UsuarioManager(BaseUserManager):
    def create_user(self, username, rut, email, password=None, **extra_fields):
        if not rut:
        ...
        user = self.model(username=username, rut=rut, email=email, **extra_fields)
        user.set_password(password)
        user.save(using=self._db)
        return user

    def create_superuser(self, username, rut, email, password=None, **extra_fields):
        ...
        return self.create_user(username, rut, email, password, **extra_fields)
